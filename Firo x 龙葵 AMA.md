...
Firo 的团队是真正全球化的，团队成员来自泰国、美国、俄罗斯、亚美尼亚和马来西亚。
...
首先，Firo 让人联想到「火」，并很好地与我们的隐私协议机制联系在一起，即燃烧币并在以后赎回全新的币。
...
我们还实施了一些其他很酷的技术，如链锁（ChainLocks），它允许对区块进行即时确认。这就是为什么像 Binance 这样的交易所接受 Firo 的 1 次确认，我们正在努力让更多的交易所接受它。它的工作原理是，它利用了随机挑选的约 400 个主节点的法定人数。这些法定人数的主节点投票决定它首先看到哪个区块，并防止任何冲突的区块。一旦大多数主节点同意，它将签署该区块，作为一个检查点，防止任何重组超过这个点。这意味着现在 51% 攻击也是不可能的，除非先把主节点干掉。

我们也非常相信通过工作量证明（Proof of Work）来保持公平分配，我们相信 GPU 是目前实现这一目标的最佳设备。ASIC 往往被少数公司控制，可用性有限。CPU 可以由机器人农场或闲置的服务器运行。这就是为什么我们将很快过渡到 ProgPoW，它是非常独特的，因为其中的随机发生器而在每个区块中不断变化，使得它很难建立一个 ASIC。我们目前的 PoW MTP 在当时也是非常独特的，因为虽然它对内存要求很高，但它仍然是非常轻量级的验证，然而它的证明尺寸非常大，因此我们认为 ProgPoW 更好。
...
Firo 保留了使原本的加密货币创意出色的所有内容，同时增加了根本的隐私元素。
...
我们的币的分配是通过挖矿和主节点，保留 15% 的开发资金，用来支付我们的开发人员、研究人员和建立有意义的伙伴关系。
...
Elysium 是我们的代币化层，允许人们建立自己的隐私代币，目前已经开始开发工作并正在测试。这在隐私稳定币或选举代币中具有潜在的用例。
...
### 用户在参与 DeFi 的同时继续获得主节点奖励，还有 Sushi 奖励。这个可以详细介绍下吗？

是的，Stakehound 有这样一个产品，你在他们那里存入 Firo，他们将主持主节点。然后他们会在 Eth 上向你发放一个名为 stFIRO 的 ERC-20 代币。这个 stFIRO 每天都会重新计算，你的余额会根据池中主节点的数量而增加。

作为一个 ERC-20 代币，你可以把它存入 Sushi 流动性池。你可以赚取 Sushi Onsen 的奖励 + 交换费 + stFIRO 的奖励。

### 我了解到 Firo 的技术水平很高，但相对于技术水平，Firo 的营销做得怎么样，目前 Firo 的粉丝增长水平如何

当然，这经常被问到，我们一直在与有影响力的人、媒体伙伴合作，并经常举行活动，如我们的 Lelantus 匿名化竞赛。但请记住，作为一个社区项目，我们也依靠社区成员来推广它，因为这是你的项目，也是我们的项目。

我们没有像 ICO 或预售那样的巨额预拨资金，因此这是更加自然的。

### Firo 未来是否会选择其他链来进行合作呢？来达到更好的发展？

当然，我们实际上一直在与其他链进行讨论，例如之前提到的 Thorchain 的整合和 REN。我们也在与 Avalanche、Horizen 和 Iotex 接触，但这些主要是关于可能的合作方式的友好讨论。我们还应该宣布与关注隐私的去中心化交易所的合作。我们相信一个多链的生态系统，每个链都专注于他们最擅长的事情，因此我们相信我们应该专注于成为去中心化的隐私数字货币，而不是试图同时做太多的事情，但没有一个做得好。

### 像所有项目一样，时间、执行和采用是 Firo 成功的关键因素，但这个项目是基于社区的力量。那么，Firo 如何产生利润以维持项目并实现可持续增长？其收入模式是什么？与其他上线不久就暴露问题的项目有什么不同？

好吧，我们本身不是一家公司。我们是一个由区块奖励资助的开源项目。把它看作是一个公司是违背了去中心化和加密货币的精神。最终这个项目应该由每个人维护，但在这之前，我们将在这里继续建设它。我们不是一个新的项目，自 2016 年以来一直存在，所以我不认为我们会很快消失。

### 我问一个技术性问题，今天大盘怎么了？

操纵。简单明了，再加上全球市场的疲软表现。Elon 发推文的时机、路透社发布的假新闻以及Wyckoff分布模式都是导致下跌的原因。不过，我确实希望最坏的情况已经过去。
